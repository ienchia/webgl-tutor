...
describe('Populate lessons using API', function () {
    ...
    describe('populate step', function () {
                ...
                if (err) {
                    ...
                    .end(function (err, res) {
                        ...
                        .end(function (err, res) {
                            expect(res).to.have.status(200)
                            agent
                            .post('/chapters/2/lessons/8/steps/27/sources')
                            .send({
                ...
                if (err) {
                    ...
                    .end(function (err, res) {
                        ...
                        .end(function (err, res) {
                            expect(res).to.have.status(200)
                            agent
                            .post('/chapters/2/lessons/9/steps/28/sources')
                            .send({
        ...
        // it('should create chapter 3 lesson 3 step a', function (done) {
        //     agent
        //     .get('/steps/b')
        //     .end(function (err, res) {
        //         if (err) {
        ...
        //                     expect(res).to.have.status(200)
        //                     agent
        //                     .post('/chapters/2/lessons/10/steps/b/sources')
        //                     .send({
        //                         content: 'zzzz',
        //                         name: 'zzzz'
        //                     })
                ...
                if (err) {
                    ...
                    .end(function (err, res) {
                        ...
                        .end(function (err, res) {
                            expect(res).to.have.status(200)
                            agent
                            .post('/chapters/2/lessons/10/steps/29/sources')
                            .send({
